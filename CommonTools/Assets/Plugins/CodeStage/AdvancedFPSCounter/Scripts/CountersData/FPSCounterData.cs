...
namespace CodeStage.AdvancedFPSCounter.CountersData
{
	...
	public class FPSCounterData: BaseCounterData
	{
		...
		private const string FPS_TEXT_START = "<color=#{0}><b>帧数: ";
		...
		private const string AVG_TEXT_START = " <color=#{0}><b>平均: ";
        ...
        string ping
        {
            get
            {
                //if (NetworkManager.ClientHandle.Ping >= 0 && NetworkManager.ClientHandle.Ping < 70)
                //{
                //    return "<color=#5BFF2F><b>网络：优</b></color>";
                //}
                //else if (NetworkManager.ClientHandle.Ping >= 70 && NetworkManager.ClientHandle.Ping <= 100)
                //{
                //    return "<color=#ECC905><b>网络：良</b></color>";
                //}
                //else if (NetworkManager.ClientHandle.Ping > 100)
                //{
                //    return "<color=#FF0000><b>网络：差</b></color>";
                //}
                //else
                {
                    return "<color=#FF0000><b>网络：差</b></color>";
	    ...
	    private string cacheBattery;
        string battery
	    {
            get
            {
                if (Time.realtimeSinceStartup - batteryTime>20)
                {
                    cacheBattery = "<color=#5BFF2F><b>电量：" + GetAndroidBatteryLevel() + "%</b></color>";
                }
                return cacheBattery;
            }
	    }
        string GetAndroidBatteryLevel()
        {
            try
            {
